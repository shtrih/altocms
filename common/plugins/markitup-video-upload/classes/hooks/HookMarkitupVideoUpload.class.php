...
class PluginMarkitupVideoUpload_HookMarkitupVideoUpload extends Hook {
    ...
    public function RegisterHook() {
        ...
        if (Config::Get('plugin.markitup_video_upload.use_in_topic'))
            $this->AddHookTemplate('topic_edit_end', $sTemplateDir . 'tpls/modals/modal.video-upload.tpl');

        if (Config::Get('plugin.markitup_video_upload.use_in_comments'))
            $this->AddHookTemplate('topic_content_end', $sTemplateDir . 'tpls/modals/modal.video-upload.tpl');

        $this->AddHookTemplate('html_head_tags', $sTemplateDir . 'tpls/html_head_tags.tpl');
    }
}
