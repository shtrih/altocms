...
class PluginCustomvideos extends Plugin {
    ...
    public function Init() {
        ...
        E::ModuleViewer()->AppendStyle($sTemplateDir . "assets/css/youtube.css");
        E::ModuleViewer()->AppendScript($sTemplateDir . "assets/js/youtube.js");
