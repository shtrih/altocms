...
$aConfig = array(
     ...
     *    Для того, чтобы обойти эти неприятные последствия, можно настроить отдачу файлов через XSendFile.
     *    Подробнее http://wiki.nginx.org/NginxXSendfile и https://tn123.org/mod_xsendfile/
     */
