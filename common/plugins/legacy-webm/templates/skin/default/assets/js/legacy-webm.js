$(function () {
    ...
    $(document).on('click', '.webm', function(e){
        ...
        var thumb = $(this),
            src = thumb.attr('src').replace('.jpg', '_full.webm'),
            webm = $('<video controls="1" loop="1" onloadedmetadata="this.volume=0.5" src="' + src + '"></video>'),
            link = $('<a href="' + src + '" target="_blank">На отдельной вкладке</a>'),
            close = $('<a href="#">Свернуть</a>'),
            container = $('<span/>').append(link, ' | ' ,close, '<br/>', webm).addClass('webmContainer'),
            video_el = webm.get(0),
