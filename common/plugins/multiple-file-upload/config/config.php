...
$aConfig = [
    ...
    /**
     * Вариант отображения списка файлов при просмотре топика.
     * Если true, то для вывода файлов топика используется хук template_topic_content_end. То есть файлы выводятся внизу топика.
     * Если false, то список файлов выводится в топике так, как выводятся прочие дополнительные поля топика, используя шаблоны tpls/fields/customs/field.custom.multiple-file-upload-*.tpl
     */
    'use-hook' => false,
